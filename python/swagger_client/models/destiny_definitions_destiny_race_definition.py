...
class DestinyDefinitionsDestinyRaceDefinition(object):
    ...
    def __init__(self, display_properties=None, gendered_race_names=None, hash=None, index=None, redacted=None):
        """
        DestinyDefinitionsDestinyRaceDefinition - a model defined in Swagger
        """
