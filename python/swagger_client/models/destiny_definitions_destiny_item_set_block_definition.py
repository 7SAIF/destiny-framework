...
class DestinyDefinitionsDestinyItemSetBlockDefinition(object):
    ...
    def __init__(self, item_list=None, require_ordered_set_item_add=None, set_is_featured=None, set_type=None):
        """
        DestinyDefinitionsDestinyItemSetBlockDefinition - a model defined in Swagger
        """
