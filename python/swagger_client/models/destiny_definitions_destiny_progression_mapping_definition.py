...
class DestinyDefinitionsDestinyProgressionMappingDefinition(object):
    ...
    def __init__(self, display_units=None, hash=None, index=None, redacted=None):
        """
        DestinyDefinitionsDestinyProgressionMappingDefinition - a model defined in Swagger
        """
