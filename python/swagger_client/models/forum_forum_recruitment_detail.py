...
class ForumForumRecruitmentDetail(object):
    ...
    def __init__(self, topic_id=None, microphone_required=None, intensity=None, tone=None, approved=None, conversation_id=None, player_slots_total=None, player_slots_remaining=None, fireteam=None, kicked_player_ids=None):
        """
        ForumForumRecruitmentDetail - a model defined in Swagger
        """
