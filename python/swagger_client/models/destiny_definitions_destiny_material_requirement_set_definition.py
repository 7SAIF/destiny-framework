...
class DestinyDefinitionsDestinyMaterialRequirementSetDefinition(object):
    ...
    def __init__(self, materials=None, hash=None, index=None, redacted=None):
        """
        DestinyDefinitionsDestinyMaterialRequirementSetDefinition - a model defined in Swagger
        """
