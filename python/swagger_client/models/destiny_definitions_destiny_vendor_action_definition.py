...
class DestinyDefinitionsDestinyVendorActionDefinition(object):
    ...
    def __init__(self, description=None, execute_seconds=None, icon=None, name=None, verb=None, is_positive=None, action_id=None, action_hash=None, auto_perform_action=None):
        """
        DestinyDefinitionsDestinyVendorActionDefinition - a model defined in Swagger
        """
