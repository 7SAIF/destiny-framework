...
class DestinyDefinitionsDestinyFactionDefinition(object):
    ...
    def __init__(self, display_properties=None, progression_hash=None, hash=None, index=None, redacted=None):
        """
        DestinyDefinitionsDestinyFactionDefinition - a model defined in Swagger
        """
