...
class DestinyDefinitionsDestinyStatDefinition(object):
    ...
    def __init__(self, display_properties=None, has_computed_block=None, hash=None, index=None, redacted=None):
        """
        DestinyDefinitionsDestinyStatDefinition - a model defined in Swagger
        """
