...
class DestinyDefinitionsSourcesDestinyItemSourceDefinition(object):
    ...
    def __init__(self, level=None, min_quality=None, max_quality=None, min_level_required=None, max_level_required=None, computed_stats=None, source_hashes=None):
        """
        DestinyDefinitionsSourcesDestinyItemSourceDefinition - a model defined in Swagger
        """
